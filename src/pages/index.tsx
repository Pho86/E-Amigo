            ...
            <main className="mt-24 flex-col flex justify-center w-full items-center p-10 gap-5">
                <div className="w-full grid grid-cols-1 max-h-[1000px] md:min-h-[600px] md:grid-cols-2">
                    ...
                    <Suspense fallback={<div>Loading...</div>}>
                        <m.div className="p-10 max-h-[600px]" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 3, delay:2 }}>
                ...
                <section id="posts" className="w-full mb-10">
                    ...
                    <div className="mt-5 grid grid-flow-row gap-6 w-full grid-cols-home">
